					...
					{["All", "IT", "Finance"].map((category) => (
						<Button
							...
							sx={{
								...
								borderBottom: selectedCategory === category ? `4px solid ${activeColor}` : "4px solid transparent",
								borderRadius: 0,
								transition: "color 0.2s ease, border-color 0.2s ease, background-color 0.2s ease",
								"&:hover": {
									backgroundColor: alpha(activeColor, isDark ? 0.08 : 0.04),
									borderBottomColor: selectedCategory === category ? activeColor : alpha(activeColor, 0.18),
								},
							}}
						>
							{category}
