        ...
        <Grid container spacing={6} alignItems="center">
          <Grid item xs={12} md={12} sx={{ order: { xs: 2, md: 1 } }}>
            <Box sx={{ maxWidth: 900, mx: "auto", textAlign: "left" }}>
              ...
              >
                The Only Resource You Will Need For Your{" "}
                <span>Business Outsourcing Needs.</span>
              </Typography>
              ...
              >
                Before you consider entrusting your business work to anyone, you
                deserve to know exactly who is accountable.
                <strong> Not a company name.</strong>{" "}
                <strong>Not a tagline.</strong> A person — with a verifiable
                background, a proven track record, and a genuine stake in this
                community.
              </Typography>
            </Box>
          </Grid>
