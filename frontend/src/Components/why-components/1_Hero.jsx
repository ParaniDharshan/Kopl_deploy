  ...
  return (
    <Box
      sx={{
        ...
        mb: { xs: 6, md: 8 },
        textAlign: "center",
        background: `radial-gradient(ellipse at 60% 30%, ${SECONDARY}18 0%, transparent 55%)`,
        position: "relative",
        overflow: "hidden",
      }}
    >
      ...
      <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Typography
          variant="h1"
          sx={{ fontSize: { xs: "2.2rem", md: "3rem" }, mb: 3 }}
        >
          The solution built around your concerns
        </Typography>
        <Typography
          sx={{ opacity: 0.7, fontSize: "1.05rem", lineHeight: 1.85, mb: 5 }}
        >
